...
from ref_formater import format_entity
    ...
    def db_load(self, entity_name, src_file_names):
        ...
        for src_file_name in src_file_names:
            ...
            for fragxml in fragparse(file_to_load, entity_name):
                uid = fragxml[0].text
                # entity_db[uid] = fragxml  # TODO: stocker les 'formes' et non pas l'entitée pour limiter l'espace consommé
                entity_db[uid] = format_entity(fragxml)
